<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between w-full gap-4">
            ...
            <a href="{{ route('admin.schedules.index', $class->id) }}" class="inline-flex items-center whitespace-nowrap text-sm font-semibold text-slate-500 hover:text-slate-800 transition-colors">
        ...
        <div class="bg-white  rounded-[18px] border border-slate-200/80 shadow-soft overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200/80  bg-slate-50/50">
                <p class="text-xs text-slate-500  font-medium">
                    Hanya <strong class="font-bold text-slate-800 ">hari & waktu</strong> yang dapat diubah di sini. Link pertemuan diatur oleh guru.
                </p>
            </div>
            <div class="p-6">
