            ...
            <div class="p-8">
                <form action="{{ route('teacher.quizzes.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="class_id" name="class_id" class="block mt-1.5 w-full bg-white text-slate-900 border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-[12px] shadow-sm py-2.5 px-3.5 transition-all text-sm" required>
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-4 border-t border-slate-100">
                        <a href="{{ route('teacher.quizzes.index') }}" class="text-sm font-semibold text-slate-500 hover:text-slate-800 transition-colors">
                            Batal
                        </a>
                        <x-primary-button>
                            Buat Kuis
